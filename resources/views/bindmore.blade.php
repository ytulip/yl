...
@section('container')
    ...
    <form id="form_data">
        <input name="address_id" value="" style="display: none;"/>
        <input name="is_default" style="display: none;"/>
        <input name="openid" style="display: none;"/>
        <div>
        ...
        <div class="cus-info-panel cus-info-panel-20">
            <div class="cus-info-panel-line inner-line">
                <div class="cus-row cus-row-v-m">
                    ...
                    <div class="cus-row-col-8">
                        <input type="text" placeholder="输入收货人姓名" class="mui-input-clear fs-14-fc-212229" name="real_name" value="">
                    </div>
            ...
            <div class="cus-info-panel-line inner-line">
                <div class="cus-row">
                    ...
                    <div class="cus-row-col-8">
                        <input placeholder="输入联系电话" type="text" class="mui-input-clear fs-14-fc-212229" name="phone" value="">
                    </div>
                    <div class="cus-row-col-1"></div>
                </div>
            </div>
            ...
            <div class="cus-info-panel-line">
                <div class="cus-row cus-row-v-t">
                    ...
                    <div class="cus-row-col-8">
                        <textarea type="text" class="mui-input-clear noscrollbars fs-14-fc-212229" name="address" placeholder="街道、门牌号等" onkeyup="autoGrow(this);"></textarea>
                    </div>
                    <div class="cus-row-col-1"></div>
                </div>
            </div>
