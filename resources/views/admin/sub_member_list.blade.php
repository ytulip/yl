...
@section('left_content')
    <div class="mt-32 padding-col">
        <div class="row">
            <div class="col-md-6 col-lg-6"><h4>下级会员信息</h4></div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <select class="form-control" name="sub_type">
                                <option>全部</option>
                                <option value="1" @if(\Illuminate\Support\Facades\Request::input('sub_type') == 1) selected @endif>下级</option>
                                <option value="2" @if(\Illuminate\Support\Facades\Request::input('sub_type') == 2) selected @endif>下下级</option>
                            </select>
                        </div>
                        <div class="input-group">
                            <input name="user_id" value="{{\Illuminate\Support\Facades\Request::input('user_id')}}" type="hidden"/>
        ...
        <div class="block-card">
            <div class="row paginate-list-row">
                ...
                <div class="col-md-2 col-lg-2">下级/下下级</div>
            ...
            @foreach($paginate as $item)
                <div class="row paginate-list-row" onclick="goDetail({{$item->id}})">
                    ...
                    <div class="col-md-2 col-lg-2">@if($item->parent_id == \Illuminate\Support\Facades\Request::input('user_id')) 下级 @else 下下级 @endif</div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div style="margin-top: 20px;">总数为：{{$paginate->total()}}</div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="fl-r"><?php echo $paginate->appends(Request::all())->render(); ?>
                </div>
            </div>
        </div>
