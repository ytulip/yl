@extends('finance.master',['headerTitle'=>'任务管理 <span class="title-gap">></span> 金融服务'])
@section('style')
    <style>
    ...
    <form id="data_form">
        ...
        <div class="block-card m-t-10">
            ...
            <div class="row paginate-list-row">
                ...
                <div class="col-md-1 col-lg-1">参加次数</div>
                <div class="col-md-2 col-lg-2">开始咨询</div>
            </div>
            ...
            @foreach($paginate as $key=>$val)
                <div class="row paginate-list-row">
                    ...
                    <div class="col-md-1 col-lg-1">{{$val->count}}</div>
                    <div class="col-md-2 col-lg-2"><a class="deliver" href="/finance-class/fill?id={{$val->id}}">开始</a></div>
                </div>
            @endforeach
