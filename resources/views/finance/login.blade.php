...
<div class="container">
    <form id="data_form">
        <div class="main">
            <a id="js-sign-up-btn" class="active" href="/sign_up">讲师登录</a>
            <div style="margin-top: 25px;">
                <div style="margin-top: 6px;"><input placeholder="输入手机号" class="form-control" name="phone" autocomplete=""/></div>
                <div style="margin-top: 6px;"><input type="number" placeholder="验证码" class="form-control" name="sms_code" style="width: 70%;display: inline-block;" autocomplete=""/><a class="get-code-btn" href="javascript:void(0)" style="display: inline-block;width: 25%"><span class="fs-14-fc-f89a03" style="display: inline-block;line-height: 45px;">获取验证码</span></a></div>
            </div>
...
<script>
    ...
    $(function () {
        new SubmitButton({
            ...
            data:function()
            {
                return {phone:$('input[name="phone"]').val(),register_sms_code:$('input[name="sms_code"]').val()}
            }
        });
