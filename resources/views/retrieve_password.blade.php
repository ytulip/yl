...
@section('container')
    ...
    <div class="cus-row p-l-r-14">
        ...
        <div class="cus-row-col-4 t-al-c"><span class="fs-17-fc-212229" style="line-height: 68px;">@if(\Illuminate\Support\Facades\Auth::check())修改密码 @else 找回密码 @endif </span></div>
    ...
    <form id="data_form">
        ...
        <div style="border-top:1px solid #EBEAEA;background-color: #ffffff">
            ...
            <div class="cus-row cus-row-bborder cus-row-v-t"  style="padding-left: 16px;">
            ...
            <div class="cus-row cus-row-bborder" style="padding-left: 16px;">
                <div class="cus-row-col-3 t-al-c"><span class="fs-16-fc-212229" style="line-height: 46px;">设置密码</span></div>
            ...
            <div class="cus-row" style="padding-left: 16px;">
                <div class="cus-row-col-3 t-al-c"><span class="fs-16-fc-212229" style="line-height: 46px;">确认密码</span></div>
    ...
    <script>
        $(function(){
            $('.get-code-btn').click(function(){
                ...
                //TODO:请求验证码
                $.post('/passport/register-sms',{phone:$('input[name="phone"]').val(),password:1},function(data){
                    if(data.status) {
                        mAlert('发送成功');
                    } else {
                        mAlert(data.desc);
        ...
        $(function () {
            new SubmitButton({
                ...
                url:'/passport/retrieve-password',
