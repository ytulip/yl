...
class FinanceClass extends Model{
    ...
    protected $table = 'finance_class';
    public $timestamps = false;
    protected $guarded = [];

    const STATUS_TAKE_PART_IN = 1;
     ...
     * 获得默认正在报名的金融讲堂
     */
    static public function getDefaultTakePart()
    {
        $obj = self::where('status',self::STATUS_TAKE_PART_IN)->orderBy('id','desc')->first();
