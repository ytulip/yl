...
//        var_dump($response);
    ...
    {
        $products = Product::where('type',Request::input('type'))->selectRaw('id, concat("'.env('IMAGE_HOST').'",cover_image) as cover_image,product_name,sub_desc,price')->where('status',1)->get();
